...
export const resumeData: ResumeData = {
  personal: {
    ...
    summary:
      "15 年 B 端产品专家，2025 年底起全面转向 AI 领域。前 15 年深耕电信 OSS/BSS，主导北京、湖南、广西等多省核心资源系统的重构与数字化转型，拥有千万级数据规模的系统落地经验，并通过售前方案支撑多个千万级项目中标。2025 年 12 月起全职投入 AI：先用 5 个月完成覆盖 12 个模块的系统性知识重构，再独立完成 AI 短视频生成产品从 0 到 1 的定义、研发与商业化，前身已完成付费定制交付。擅长把大模型能力转化为可交付、成本可控、过程可审计的产品——在 LLM 应用架构、多模型编排、成本与配额治理、模型评测上有完整实战。北京邮电大学工程管理硕士，持 IPMP 国际项目经理认证及系统集成项目管理师证书。",
  },

  stats: [
    { value: "15+", label: "年产品经验" },
    { value: "3", label: "AI 产品 0→1" },
    { value: "千万级", label: "售前支撑中标" },
  ...
  strengths: [
    {
      ...
      description:
        "独立完成 AI 短视频生成产品的需求定义、架构设计、研发交付与商业化，需求规格迭代至 v3.5，前身已完成付费定制交付。",
    },
    {
      title: "AI 工程化与成本治理",
  ...
  skills: [
    ...
    },
    {
      ...
      items: [
        ...
        "Remotion 视频合成",
        "多模型 API 集成（Claude / Gemini / 阿里云 / 字节跳动等）",
  ...
  experience: [
    {
      ...
      location: "",
      description: [
        "2024.11 — 2025.11 利用业余时间系统学习 AI 课程，掌握 LLM 基础、提示词、多模态等核心概念",
        ...
        "2026.05 至今主导两条产品线：「无相」AI 口播短视频生成器（面向内容创作者的桌面级 AI 生产工具，前身已完成付费定制交付）与 AI 内容管线平台（多模型编排 + 成本治理的自建基础设施）",
  ...
  projects: [
    {
      ...
      highlights: [
        ...
        {
          label: "成本模型",
          text: "建立按量付费成本模型并完成实测验证：AI 生成成本约 ¥5/分钟，3 分钟成片总成本 ¥15.4，零显卡投入；相对外包代剪与订阅制工具形成数量级成本优势。",
        },
        {
          label: "成本护栏",
        ...
        {
          label: "商业落地",
          text: "先以定制开发形式完成付费交付（跑通需求分析、交付支持、客户验收的完整闭环），后产品化为桌面应用「无相」，现作为自有内容生产工具持续迭代。",
        },
        {
          label: "工程交付",
